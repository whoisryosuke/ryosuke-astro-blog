...
First I’d like to take a look at what we function we currently use to load models and how it works, that way we can borrow functionality and make sure it rreturns t
