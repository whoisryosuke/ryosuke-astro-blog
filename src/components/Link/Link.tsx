import { linkColorPrimaryStyles, linkInlineStyles, linkStyles, linkPlainStyles } from './Link.css';
...
export function Link({ children, className,textClass, fontFamily, fontSize, fontWeight, lineHeight, ghost = false, underline = true, color, ...props }: LinkProps) {
  ...
  return (
      <a className={clsx(linkStyles, className, ghostStyles, underlineStyles)} {...props}>
